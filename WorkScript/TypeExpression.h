...
const std::string TYPENAME_FUNCTION_EXPRESSION = "FunctionExpression";
const std::string TYPENAME_TERM_EXPRESSION = "TermExpression";
const std::string TYPENAME_GREATER_THAN_EXPRESSION = "GreaterThanExpression";
const std::string TYPENAME_GREATER_THAN_EQUAL_EXPRESSION = "GreaterThanEqualExpression";
const std::string TYPENAME_LESS_THAN_EXPRESSION = "LessThanExpression";
const std::string TYPENAME_LESS_THAN_EQUAL_EXPRESSION = "LessThanEqualExpression";
...
const std::string TYPENAME_BOOLEAN_EXPRESSION = "Boolean";
