...
SystemContext::SystemContext()
{
	...
	auto polynomialExpressionType = SPTYPEEXPRESSION(new TypeExpression(this, expressionType))->setName(TYPENAME_POLYNOMIAL_EXPRESSION);
	auto plusExpressionType = SPTYPEEXPRESSION(new TypeExpression(this, polynomialExpressionType))->setName(TYPENAME_PLUS_EXPRESSION);
	auto minusExpressionType = SPTYPEEXPRESSION(new TypeExpression(this, polynomialExpressionType))->setName(TYPENAME_MINUS_EXPRESSION);
	auto multiplyExpressionType = SPTYPEEXPRESSION(new TypeExpression(this, polynomialExpressionType))->setName(TYPENAME_MULTIPLY_EXPRESSION);
	auto divideExpressionType = SPTYPEEXPRESSION(new TypeExpression(this, polynomialExpressionType))->setName(TYPENAME_DIVIDE_EXPRESSION);
	...
	auto printExpressionType = SPTYPEEXPRESSION(new TypeExpression(this, polynomialExpressionType))->setName(TYPENAME_PRINT_EXPRESSION);
	auto thisExpressionType = SPTYPEEXPRESSION(new TypeExpression(this, polynomialExpressionType))->setName(TYPENAME_THIS_EXPRESSION);
	auto memberEvaluateExpressionType = SPTYPEEXPRESSION(new TypeExpression(this, polynomialExpressionType))->setName(TYPENAME_MEMBER_EVALUATE_EXPRESSION);
	...
	auto multiValueExpressionType = SPTYPEEXPRESSION(new TypeExpression(this, polynomialExpressionType))->setName(TYPENAME_MULTI_TERM_EXPRESSION);
	auto identifierExpressionType = SPTYPEEXPRESSION(new TypeExpression(this, polynomialExpressionType))->setName(TYPENAME_IDENTIFIER_EXPRESSION);
	...
	auto parentheseExpressionType = SPTYPEEXPRESSION(new TypeExpression(this, polynomialExpressionType))->setName(TYPENAME_PARENTHESE_EXPRESSION);
	auto rawValueExpressionType = SPTYPEEXPRESSION(new TypeExpression(this, polynomialExpressionType))->setName(TYPENAME_RAW_VALUE_EXPRESSION);
	...
	this->addType(polynomialExpressionType);
	this->addType(plusExpressionType);
	this->addType(minusExpressionType);
	this->addType(multiplyExpressionType);
	this->addType(divideExpressionType);
