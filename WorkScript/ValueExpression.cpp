...
ValueExpression::ValueExpression(Context *const &context)
	:Expression(context)
{
}
...
const std::shared_ptr<const Expression> ValueExpression::matchFirstUpInContextAndEvaluate(const std::shared_ptr<const Expression>& matchExpression) const
{
