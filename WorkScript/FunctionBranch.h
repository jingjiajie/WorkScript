...
namespace WorkScript 
{
	...
	{
	public:
		inline FunctionBranch(BranchFunction *function, Location loc)
		{
			this->function = function;
			this->location = loc;
		}

		inline FunctionBranch(BranchFunction *function, Location loc, const std::vector<Expression*> &constraints, const std::vector<Expression*> &implements)
		{
			this->function = function;
			this->location = loc;
