...
namespace WorkScript {
	...
	public:
		...
		static ResolveResult resolve(const ExpressionInfo &exprInfo, InstantializeContext *ctx, std::vector<Type*> paramDeclTypes, std::vector<Expression*> declParams, std::vector<Expression*> constraints);
	};
}