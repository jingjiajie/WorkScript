...
namespace WorkScript {
	...
	public:
		...
		static ResolveResult resolve(const ExpressionInfo &exprInfo, SymbolTable *abstractSymbolTable, std::vector<Expression*> declParams, std::vector<Expression*> constraints);
	};
}